...
| `specs/**/PLAN_*.md`, `**/HEAL_*.md`, `**/CLASIF_*.json`, `scripts/classify-failures.mjs` | "healer", "self-healing", "planner IA", "clasificar fallos playwright", "presupuesto IA" | `playwright-ai-agents-skill` — complementa a `playwright-skill`, se selecciona junto a ella | 15 / 8 |
